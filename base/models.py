...
class Collectingdb(models.Model):
    ...
    updated = models.DateTimeField(auto_now=True)
    status = models.CharField(max_length=10, choices=STATUS_CHOICES, default='신규', verbose_name='status')
    status2 = models.CharField(max_length=10, choices=STATUS_CHOICES2, default='no', verbose_name='구매확정여부')
    # input = hidden : dbcode db01 - 문의하기db  db02 -  랜딩페이지 db  db03 - 추가 홍보페이지
    ...
    class Meta:
        # db_table = 'py_user'
        verbose_name = '상담신청DB01'
        verbose_name_plural = '상담신청DB01'
        ordering = ['-created']

class Collectingdb002(models.Model):
    # learn django - the easyway [youtube]  
    ...
    class Meta:
        # db_table = 'py_user'
        verbose_name = '상담신청DB02'
        verbose_name_plural = '상담신청DB02'
        ordering = ['-created']